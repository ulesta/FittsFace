...
//                    		Log.d("state", "count=" + runningCalibrationCounter);
                ...
                runningArrayX[runningCounter] = Math.sin(yaw*(Math.PI/180)) * scaleUnitCircle;
                runningArrayY[runningCounter] = Math.sin(pitch*(Math.PI/180)) * scaleUnitCircle;
                
                Log.d("running", "xthetha=" + yaw*(Math.PI/180) + "\tx=" + runningArrayX[runningCounter] + "\tytheta=" + (pitch + 15)*(Math.PI/180) + "\ty=" + runningArrayY[runningCounter]);
